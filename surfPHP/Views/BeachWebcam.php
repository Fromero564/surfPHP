...
<html lang="en">
   <head>
    ...
    <title>Beach Webcam | Nukumoi Surf Co.</title>
  ...
  <body>
    ...
    <div class="overlayslideOurStory" style="padding:100px">
    <h1 class="Livecam-title">Poipu Beach Live Cam</h1>
  ...
  <footer class="footer">
   <div class="column1">
        ...
        <ul>
          ...
          <li><i class="fas fa-envelope"></i><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="afccc7ddc6dcdbc6c1caefc1dac4dac2c0c681ccc0c2">[email&#160;protected]</a></li>
