  ...
  <nav class="menu-noresponsive sticky">
    ...
    <div class="text-information">
      <div class="title-info">
        <h2>Surf Guide for advanced surfers only</h2>
      </div>
      <div class="card-info">
        <p>QUICK DETAILS</p>
        <div class="">
    ...
    <div class="extra-info">
      <p>
        (our experienced local surf instructor will take you to the best wave on
        that day, according to the swell, winds, and tide for your desired wave
        and ability. This is for Intermediate and Advanced surfing only. Uncover
        insider tips, safety advice for reef breaks, local culture, ensuring an
        unforgettable surfing experience on the stunning Garden Isle. (South
        Shore $.., road trip $.. ) 1-4 people
      </p>
    </div>
